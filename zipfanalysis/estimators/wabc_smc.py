...
def wabc_smc_zipf(ns, min_exponent=1.01, max_exponent=4, n_particles = 512, survival_fraction = 0.2):
	...
	for run_count in range(15):
		...
		if abs(epsilon_k - epsilon_k_last) < 0.00001:
			break
